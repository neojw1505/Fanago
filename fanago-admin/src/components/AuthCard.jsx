...
// Set Role
   const [roleId, setRoleId] = React.useState("2");
  ...
  const confirmRegistration = async (email, confirmationCode, roleId) => {
    setIsLoading(true);
    try {
...
const login = async (email, password) => {
  ...
  const handleConfirmRegistration = async (e) => {
    e.preventDefault()
    await confirmRegistration(email, confirmationCode, roleId)
  }
