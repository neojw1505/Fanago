...
export default function NationalStadium({ seatMap, onSeatSelect }) {
  ...
  return (
    <div className="w-full">
      ...
      >
        <g ref={gRef}>
          <g id="224" className="" style={{ cursor: "pointer" }}>
            <g>
              <polygon
                fill="#add9a1"
                points="581.7,152.5 615.1,78.8 667.7,107.3 593.8,159"
              ></polygon>
              <polygon
                fill="#add9a1"
                points="615.2,79.2 667.2,107.3 593.8,158.7 582.1,152.4"
              ></polygon>
              <polygon
                fill="#add7a1"
                points="593.5,158.6 667.4,106.8 668.7,115.2 594.7,167"
              ></polygon>
              <polygon
                fill="#add7a1"
                points="667.2,107.3 668.4,115.1 594.9,166.5 593.8,158.7"
              ></polygon>
              <polygon
                fill="#a9d39f"
                points="582.9,160.4 581.7,151.9 594.1,158.5 595.3,167"
              ></polygon>
              <polygon
                fill="#a9d39f"
                points="593.8,158.7 594.9,166.5 583.2,160.2 582.1,152.4"
              ></polygon>
            </g>
          </g>
          <g id="225" className="" style={{ cursor: "pointer" }}>
            <g>
              <polygon
                fill="#e7c18f"
                points="527.9,95 526.7,87 527.3,86.9 550.5,142.6 551.7,150.6 551.1,150.7"
              ></polygon>

              <polygon
                fill="#e7c18f"
                points="550.2,142.7 551.4,150.6 528.2,94.9 527,87"
              ></polygon>

              <polygon
                fill="#edc38f"
                points="549.9,142.5 563.1,139.7 564.3,148 551.2,150.9"
              ></polygon>

              <polygon
                fill="#edc38f"
                points="562.9,140 564,147.8 551.4,150.6 550.2,142.7"
              ></polygon>

              <polygon
                fill="#ebc38f"
                points="575.4,154.5 574.3,146.7 597.3,69.5 597.9,69.6 599,77.4 576,154.6"
              ></polygon>

              <polygon
                fill="#ebc38f"
                points="597.6,69.6 598.7,77.4 575.7,154.5 574.6,146.7"
              ></polygon>

              <polygon
                fill="#efc58f"
                points="562.7,140.3 550,143 526.6,86.8 598,69.2 574.8,146.9 564.6,149"
              ></polygon>

              <polygon
                fill="#efc58f"
                points="527,87 597.6,69.6 574.6,146.7 564.8,148.7 562.9,140 550.2,142.7"
              ></polygon>

              <polygon
                fill="#edc38f"
                points="564.5,148.5 574.8,146.4 576,154.7 565.8,156.8"
              ></polygon>

              <polygon
                fill="#edc38f"
                points="574.6,146.7 575.7,154.5 566,156.5 564.8,148.7"
              ></polygon>
              <polygon
                fill="#e7c18f"
                points="563.7,147.9 562.6,140 563.2,139.9 565.1,148.6 566.3,156.5 565.7,156.6"
              ></polygon>
              <polygon
                fill="#e7c18f"
                points="564.8,148.7 566,156.5 564,147.8 562.9,140"
              ></polygon>
            </g>
          </g>
          <g id="226" className="" style={{ cursor: "pointer" }}>
            <g>
              <polygon
                fill="#edc38f"
                points="517,150.4 541.8,143.2 543,151.7 518.3,158.8"
              ></polygon>

              <polygon
                fill="#edc38f"
                points="541.6,143.6 542.7,151.5 518.5,158.4 517.3,150.6"
              ></polygon>
              ...
              <polygon
                fill="#ebc38f"
                points="509.2,167.9 521.2,165.8 522.5,174.1 510.4,176.2"
              ></polygon>

              <polygon
                fill="#ebc38f"
                points="521,166.1 522.2,173.9 510.6,175.9 509.5,168.1"
              ></polygon>

              <polygon
                fill="#e7c18f"
                points="476.7,137.3 475.4,128.5 509.8,168 511,176.8"
              ></polygon>

              <polygon
                fill="#e7c18f"
                points="509.5,168.1 510.6,175.9 477,137.2 475.8,129.4"
              ></polygon>

              <polygon
                fill="#e7c18f"
                points="456,113.8 454.7,105 476.1,129.3 477.4,138.1"
              ></polygon>

              <polygon
                fill="#e7c18f"
                points="475.8,129.4 477,137.2 456.3,113.7 455.1,105.9"
              ></polygon>
            </g>
          </g>
          <g id="227" className="" style={{ cursor: "pointer" }}>
            <g>
              <polygon
                fill="#a9d39f"
                points="411.7,145.1 410.5,136.6 423.5,143.5 424.7,152.1"
              ></polygon>

              <polygon
                fill="#a9d39f"
                points="423.2,143.7 424.3,151.6 412,144.9 410.9,137.1"
              ></polygon>

              <polygon
                fill="#a9d39f"
                points="424,151.8 422.8,143.2 453.3,159.7 454.6,168.2"
              ></polygon>

              <polygon
                fill="#a9d39f"
                points="453,159.9 454.2,167.7 424.3,151.6 423.2,143.7"
              ></polygon>

              <polygon
                fill="#a9d39f"
                points="453.9,167.9 452.6,159.4 491.7,180.5 493,189"
              ></polygon>

              <polygon
                fill="#a9d39f"
                points="491.4,180.7 492.6,188.5 454.2,167.7 453,159.9"
              ></polygon>

              <polygon
                fill="#add7a1"
                points="491.1,180.6 506.9,169.5 508.1,177.9 492.4,189"
              ></polygon>

              <polygon
                fill="#add7a1"
                points="506.7,170 507.8,177.8 492.6,188.5 491.4,180.7"
              ></polygon>
          ...
          <g id="218" className="" style={{ cursor: "pointer" }}>
            <g>
              <polygon
                fill="#abd79f"
                points="874.4,255.4 920.4,243.3 921.6,251.7 875.6,263.8"
              ></polygon>

              <polygon
                fill="#abd79f"
                points="920.2,243.7 921.3,251.5 875.8,263.4 874.7,255.6"
              ></polygon>

              <polygon
                fill="#abd79f"
                points="869.1,256.8 874.9,255.2 876.1,263.6 870.4,265.2"
              ></polygon>

              <polygon
                fill="#abd79f"
                points="874.7,255.6 875.8,263.4 870.6,264.8 869.4,257"
              ></polygon>

              <polygon
                fill="#abd79f"
                points="805.6,273.4 869.6,256.6 870.9,265 806.9,281.8"
              ></polygon>

              <polygon
                fill="#abd79f"
                points="869.4,257 870.6,264.8 807.1,281.4 805.9,273.6"
              ></polygon>

              <polygon
                fill="#a9d39f"
                points="796.7,276.2 795.4,267.7 806.2,273.4 807.5,281.9"
              ></polygon>

              <polygon
                fill="#a9d39f"
                points="805.9,273.6 807.1,281.4 797,276 795.8,268.2"
              ></polygon>
              <polygon
                fill="#add9a1"
          ...
          <g id="217" className="" style={{ cursor: "pointer" }}>
            <g>
              <polygon
                fill="#ebc38f"
                points="815.4,283.2 831.3,281.9 832.6,290.3 816.7,291.6"
              ></polygon>
              <polygon
                fill="#ebc38f"
                points="831.1,282.2 832.3,290 816.9,291.3 815.7,283.5"
              ></polygon>
              <polygon
                fill="#efc58f"
                points="827.6,290.4 830.7,282.5 815.3,283.8 817.3,278.2 938.5,251.9 917.2,298.7"
              ></polygon>
              <polygon
                fill="#efc58f"
                points="817.5,278.4 938,252.3 917,298.4 828,290.2 831.1,282.2 815.7,283.5"
              ></polygon>
              <polygon
                fill="#edc38f"
                points="916.7,298.4 938.1,251.3 939.5,260.1 918.1,307.2"
              ></polygon>
              <polygon
                fill="#edc38f"
                points="938,252.3 939.2,260.1 918.2,306.2 917,298.4"
              ></polygon>
              <polygon
                fill="#e9c18f"
                points="829,298.3 827.7,289.9 917.2,298.1 918.5,306.5"
              ></polygon>
              <polygon
                fill="#e9c18f"
                points="917,298.4 918.2,306.2 829.2,298 828,290.2"
              ></polygon>
            </g>
          </g>
          <g id="216" className="" style={{ cursor: "pointer" }}>
            <g>
              <polygon
                fill="#e9c18f"
                points="792.7,327.2 791.5,318.8 845.3,331.6 846.5,340"
              ></polygon>
              <polygon
                fill="#e9c18f"
                points="845,331.8 846.2,339.6 793,327 791.8,319.2"
              ></polygon>
              <polygon
                fill="#efc58f"
              ...
              <polygon
                fill="#e9c18f"
                points="845.9,339.8 844.7,331.4 896.8,343.7 898,352.1"
              ></polygon>
              <polygon
                fill="#e9c18f"
                points="896.5,343.9 897.7,351.7 846.2,339.6 845,331.8"
              ></polygon>
              <polygon
                fill="#edc38f"
                points="896.2,343.9 915.2,302.7 916.6,311.5 897.6,352.7"
              ></polygon>
              <polygon
                fill="#edc38f"
                points="915.1,303.7 916.3,311.5 897.7,351.7 896.5,343.9"
              ></polygon>
            </g>
          </g>
          <g id="215" className="" style={{ cursor: "pointer" }}>
            <g>
              <polygon
                fill="#a9d39f"
                points="813.6,361.7 812.4,353.2 843.1,369.8 844.4,378.3"
              ></polygon>
              <polygon
                fill="#a9d39f"
                points="842.8,370 844,377.8 813.9,361.5 812.8,353.7"
              ></polygon>
              <polygon
                fill="#a9d39f"
                points="843.7,378 842.4,369.5 854.2,375.8 855.4,384.3"
              ></polygon>
              <polygon
                fill="#a9d39f"
                points="853.9,376 855,383.8 844,377.8 842.8,370"
              ></polygon>
              <polygon
                fill="#add9a1"
                points="842.7,370.2 812.7,353.9 772.6,332.2 786.6,322.5 838.1,335.7 892,349.7 853.9,376.3"
              ></polygon>
              <polygon
                fill="#add9a1"
                points="786.7,322.8 838,336 877,346.1 891.3,349.8 853.9,376 842.8,370 812.8,353.7 773.1,332.2"
              ></polygon>
              <polygon
                fill="#add7a1"
                points="853.6,375.9 891.5,349.3 892.7,357.7 854.8,384.3"
              ></polygon>
              <polygon
                fill="#add7a1"
                points="891.3,349.8 892.4,357.6 855,383.8 853.9,376"
              ></polygon>
              <polygon
                fill="#a9d39f"
                points="774,340.3 772.7,331.7 813.1,353.5 814.3,362"
              ></polygon>
              <polygon
                fill="#a9d39f"
                points="812.8,353.7 813.9,361.5 774.3,340.1 773.1,332.2"
              ></polygon>
            </g>
          </g>
          ...
          <g id="209" className="" style={{ cursor: "pointer" }}>
            <g>
              <polygon
                fill="#d5d1ab"
                points="534.3,508.1 533,499.6 603.1,537.5 604.4,546"
              ></polygon>

              <polygon
                fill="#d5d1ab"
                points="602.8,537.7 604,545.5 534.6,507.9 533.4,500.1"
              ></polygon>

              <polygon
                fill="#d5d1ab"
                points="603.7,545.7 602.4,537.2 614.4,543.6 615.7,552.1"
              ></polygon>

              <polygon
                fill="#d5d1ab"
                points="614.1,543.8 615.3,551.6 604,545.5 602.8,537.7"
              ></polygon>

              <polygon
                fill="#dbd7af"
                points="613.8,543.7 647.8,519.9 649,528.3 615.1,552.1"
              ></polygon>

              <polygon
                fill="#dbd7af"
                points="647.6,520.4 648.7,528.2 615.3,551.6 614.1,543.8"
              ></polygon>

              <polygon
                fill="#ddd7af"
                points="602.7,537.9 532.9,500.1 566.8,476.4 636.4,514.1 648.1,520.4 614.1,544.1"
              ></polygon>

              <polygon
                fill="#ddd7af"
                points="566.8,476.7 636.3,514.3 647.6,520.4 614.1,543.8 602.8,537.7 533.4,500.1"
              ></polygon>
            </g>
          </g>
          ...
          <g id="233" className="" style={{ cursor: "pointer" }}>
            <g>
              <polygon
                fill="#d5d1ab"
                points="170.7,313.9 169.4,305.4 182.7,312.5 184,321"
              ></polygon>

              <polygon
                fill="#d5d1ab"
                points="182.4,312.7 183.6,320.5 171,313.7 169.8,305.9"
              ></polygon>

              <polygon
                fill="#d5d1ab"
                points="183.3,320.7 182,312.2 250.7,349.3 251.9,357.8"
              ></polygon>

              <polygon
                fill="#d5d1ab"
                points="250.4,349.5 251.5,357.3 183.6,320.5 182.4,312.7"
              ></polygon>

              <polygon
                fill="#dbd7af"
                points="250.1,349.4 288,322.8 289.2,331.2 251.3,357.8"
              ></polygon>

              <polygon
                fill="#dbd7af"
                points="287.8,323.3 288.9,331.1 251.5,357.3 250.4,349.5"
              ></polygon>
              <polygon
                fill="#ddd7af"
                points="182.3,312.9 169.3,305.9 207.2,279.4 219.9,286.3 288.3,323.3 250.4,349.8"
              ></polygon>
              <polygon
                fill="#ddd7af"
                points="207.2,279.7 219.8,286.5 287.8,323.3 250.4,349.5 182.4,312.7 169.8,305.9"
              ></polygon>
            </g>
          </g>
          <g id="208" style={{ cursor: "pointer" }}>
            <g>
              <polygon
                fill="#833F3F"
                points="575.5,572.4 607.9,549.7 609.2,558.2 576.7,580.8"
              ></polygon>
              <polygon
                fill="#833F3F"
                points="607.7,550.1 608.9,558 576.9,580.3 575.8,572.5"
              ></polygon>
              <polygon
                fill="#7B3B3B"
                points="495.9,536.8 494.6,528.3 576.1,572.4 577.3,580.9"
              ></polygon>
              <polygon
                fill="#7B3B3B"
                points="575.8,572.5 576.9,580.3 496.2,536.6 495,528.8"
              ></polygon>
              <polygon
                fill="#853F3F"
                points="494.5,528.9 527,506.1 608.2,550.1 575.8,572.9"
              ></polygon>
              <polygon
                fill="#853F3F"
                points="527,506.5 607.7,550.1 575.8,572.5 495,528.8"
              ></polygon>
            </g>
          </g>
          <g id="234" style={{ cursor: "pointer" }}>
            <g>
              <polygon
                fill="#833f3f"
                points="211.5,378.2 247.3,353.2 248.6,361.6 212.8,386.6"
              ></polygon>

              <polygon
                fill="#833f3f"
                points="247.1,353.6 248.3,361.4 213,386.1 211.8,378.3"
              ></polygon>

              <polygon
                fill="#7b3b3b"
                points="132.2,342.7 130.9,334.1 212.1,378.2 213.4,386.7"
              ></polygon>

              <polygon
                fill="#7b3b3b"
                points="211.8,378.3 213,386.1 132.5,342.5 131.3,334.6"
              ></polygon>
              <polygon
                fill="#853f3f"
                points="130.8,334.7 166.6,309.6 247.6,353.6 211.8,378.7"
              ></polygon>
              <polygon
                fill="#853f3f"
                points="166.6,309.9 247.1,353.6 211.8,378.3 131.3,334.6"
              ></polygon>
            </g>
          </g>
        </g>
